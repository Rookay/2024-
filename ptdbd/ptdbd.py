...
# 1. 加载数据集
normal_data = pd.read_csv('D:/data/archive/ptbdb_normal.csv', header=None)
abnormal_data = pd.read_csv('D:/data/archive/ptbdb_abnormal.csv', header=None)
...
# 3. 初始化模型、损失函数和优化器
model = ECG_LSTM_Model(input_size=1, hidden_layer_size=64, output_size=2)
